...
function DefaultLayout({children}: { children: React.ReactNode | React.ReactNode[] }) {
    ...
    return (
        <div className="min-h-[calc(100svh+60px)] lg:min-h-screen bg-gray-50">
            {/* Desktop Sidebar */}
            <div
                className="hidden lg:flex lg:w-64 lg:flex-col lg:fixed lg:inset-y-0 lg:bg-white lg:border-r lg:border-gray-200">
                <div className="flex-1 flex flex-col min-h-0">
                    {/* Logo */}
                    <div
                        className="flex items-center h-16 flex-shrink-0 px-4 bg-gradient-to-r from-purple-600 to-blue-600">
                    ...
                    <div className="flex-shrink-0 p-4 border-t border-gray-200">
                        <button onClick={() => setShowSignOutConfirm(true)}
                                className="group flex items-center px-2 py-2 text-sm font-medium rounded-lg w-full text-left text-gray-600 hover:bg-gray-50 hover:text-gray-900 transition-colors">
            ...
            {isMobileMenuOpen && (
                <div className="lg:hidden fixed inset-0 z-50">
                    ...
                    <div className="fixed inset-y-0 left-0 w-64 bg-white shadow-xl">
                        <div
                            className="flex items-center justify-between h-16 px-4 bg-gradient-to-r from-purple-600 to-blue-600">
                            <h1 className="text-xl font-bold text-white">PloyJai</h1>
                            <button
